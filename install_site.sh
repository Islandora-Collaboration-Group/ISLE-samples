...
echo "Using Drush makefile to create sample Drupal site within /var/www/html"
/usr/local/bin/drush make --prepare-install /home/islandora/site/drupal.drush.make /home/islandora/site/drupal_install

echo "Using Islandora makefile for Islandora Modules for sample Drupal site within /var/www/html"
/usr/local/bin/drush make --no-core /home/islandora/site/islandora.drush.make /var/www/html/drupal_install

echo "Copy /home/islandora/site/drupal contents to /var/www/html"
cp -Rv /home/islandora/site/drupal_install/. /var/www/html/sites/default/
