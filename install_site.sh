...
/usr/local/bin/drush make --prepare-install /home/islandora/site/drupal.drush.make /var/www/html

echo "Using Islandora makefile for Islandora Modules for sample Drupal site within /var/www/html"
/usr/local/bin/drush make --no-core /home/islandora/site/islandora.drush.make /var/www/html
